    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nickname', models.CharField(blank=True, max_length=150, null=True, unique=True, verbose_name='Nickname')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usuario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='metas_anuais', to=settings.AUTH_USER_MODEL)),
            ],
            options={
